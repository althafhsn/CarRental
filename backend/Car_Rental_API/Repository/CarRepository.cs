        ...
        public Car CreateCar(Car car)
        {
            try
            {
                ...
                string insertQuery = @"INSERT INTO Cars (CarId,ImagePath,Brand,Model,GearType,SeatCount,FuelType,Mileage,Year,RegNo,DailyPrice,CarStatus)
                                       VALUES (@carId,@imagePath,@brand,@model,@gearType,@seatCount,@fuelType,@mileage,@year,@regNo,@dailyPrice,@carStatus);";
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(insertQuery, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@carStatus", car.CarStatus);
